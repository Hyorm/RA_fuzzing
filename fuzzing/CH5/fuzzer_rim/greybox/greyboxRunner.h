...
typedef struct _greyboxRunner{
	...
	struct _greyboxRunner (*run)(struct _greyboxRunner, char*, char**, int, int, int);	

}greyboxRunner;

struct _greyboxRunner run_greyboxRunner(greyboxRunner gr, char* filename, char** seed, int seed_size, int min_mtt, int max_mtt);
